# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_Agents.ipynb.

# %% auto 0
__all__ = ['Logger', 'Agent']

# %% ../nbs/01_Agents.ipynb 6
import uuid
from typing import Any, List, Optional

# %% ../nbs/01_Agents.ipynb 7
...
from .utilities.prompts_components import *
from .utilities.prompts import *
from .agents.cache_handler import *

# %% ../nbs/01_Agents.ipynb 8
class Logger:
...
class Agent(BaseModel):
    ...
    agent_executor: InstanceOf[AgentExecutor] = Field(
    ...
    def _create_agent_executor(self) -> None:
        ...
        # else:
        prompt = Prompts(i18n=self.i18n).task_execution_openai()
        ...
        self.agent_executor = AgentExecutor(agent=agent,  **executor_args)
        # CrewAgentExecutor(
